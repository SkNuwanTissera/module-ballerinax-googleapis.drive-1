...
public function main() {
    ...
    stream<drive:File,error>|error res = driveClient->getSlidesByName("ballerina");
    // stream<drive:File,error>|error res = driveClient->getSlidesByName("ballerina", 2);
    // stream<drive:File,error>|error res = driveClient->getSlidesByName("ballerina", 2, "createdTime");
